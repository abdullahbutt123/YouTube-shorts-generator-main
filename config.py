...
reddit_login = {
	'client_id': 'V2g4vDl7M6WfhXSWqpwElQ',
	'client_secret': 'NewB72v7eac_hauqiVGRFWOcExdW6A',
	'password': 'Mikotosuoh1',
	'user_agent': 'youtubeshortsgen',
	'username': 'BackgroundMark9875'
}
...
# Note that by default, public isn't available unless you go through an audit. Checkout:
